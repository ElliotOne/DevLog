        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageVirtualPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailOrPhoneNumber = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GooglePlus = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    WalletName1 = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    WalletAddress1 = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    WalletName2 = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    WalletAddress2 = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    WalletName3 = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    WalletAddress3 = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    WalletName4 = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    WalletAddress4 = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    IsCommentsOn = table.Column<bool>(type: "bit", nullable: false),
                    ImageVirtualPath = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
